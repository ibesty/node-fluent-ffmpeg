...
declare namespace Ffmpeg {
    ...
    function availableHwAccels(callback: FormatsCallback): void;
    function getAvailableHwAccels(callback: FormatsCallback): void;
    ...
    class FfmpegCommand extends events.EventEmitter {
        ...
        availableHwAccels(callback: FormatsCallback): void;
        getAvailableHwAccels(callback: FormatsCallback): void;
